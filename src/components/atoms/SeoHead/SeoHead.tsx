...
const SeoHead = ({
	...
	keywords,
	image = 'https://res.cloudinary.com/matthewnguyen/image/upload/v1641565970/website-dark-light.png',
	meta,
}: HeadProps) => {
	return (
		<Head>
			...
			<meta name="og:url" content="https://matthewnguyen.com/" />
